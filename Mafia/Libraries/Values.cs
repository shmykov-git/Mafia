...
{
    public static string[] BanOperations = [nameof(CityOperations.CityBan)];
    public static string[] KillOperations = [nameof(Operations.Kill), nameof(Operations.RoundKill), nameof(CityOperations.CityKill), nameof(CityOperations.CityBan)];
    public static string[] KillNoBanOperations = [nameof(Operations.Kill), nameof(Operations.RoundKill), nameof(CityOperations.CityKill)];
